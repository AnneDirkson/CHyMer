...
class EntityExtractor(): 
    ...
    #                         dist['end_ent'].append(num)
                        ...
                        if tags[num-1] != 'HB-ADR': ##it is loose and could be sandwiched (or it just a second HI)

                            if tags[num-1] == 'HI-ADR': ##it is OK
                                tempwords.append(word)
                                temptags.append(a)
                                temprange.append(num)
                                try: 
